...
for epoch in range(epochs):
    ...
    if epoch == epochs - 1:
        torch.save(student_model.state_dict(), "student_{}.ckpt".format(total_accuracy / test_len))
        torch.save(student_model.state_dict(), "student_{:.8}.ckpt".format(total_accuracy / test_len))
        print("模型已保存")
